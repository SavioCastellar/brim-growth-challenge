...
const chartConfig = {
  qualified_leads: {
    ...
    color: "var(--qualified_leads)",
  },
  activations: {
    label: "Activations",
    color: "var(--activations)",
  },
          ...
          <AreaChart data={filteredData}>
            <defs>
              <linearGradient id="fillQualifiedLeads" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="var(--color-qualified_leads)" stopOpacity={1.0} />
                <stop offset="95%" stopColor="var(--color-qualified_leads)" stopOpacity={0.1} />
              </linearGradient>
            ...
            <Area
              ...
              type="natural"
              fill="url(#qualified_leads)"
              stroke="var(--qualified_leads)"
              stackId="a"
            />
            <Area
              dataKey="activations"
